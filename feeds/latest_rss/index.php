<?php
/**
 * File defines the RSSFeedController PageController class
...
/**
 * Page to generate RSS feed for events
 *
 ...
 * @package PageController
 */
class RSSFeedController implements Controller {
    /**
    ...
    public function __construct () {
        $this->template = new PageTemplate (joinPath ("feeds", "events_feed_tpl.php"));
    }
